...
You can try this app online via [StackBlitz](https://stackblitz.com/~/github.com/AhmedH10/ai-chat-web-app).
...
1. Open the project in [StackBlitz](https://stackblitz.com/~/github.com/AhmedH10/ai-chat-web-app).
